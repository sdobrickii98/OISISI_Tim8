...
public class DodajLek extends JDialog {
	...
	public DodajLek() {
		...
		contentPanel.setLayout(gbl_contentPanel);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(DodajLek.class.getResource("/slike/imelaLogo.jpg")));
					...
					public void actionPerformed(ActionEvent e) {
						...
						for (Lek l : ListaLekova.getInstance().getLekovi()) {
							...
							if (sifra.getText().equals(l.getSifra())) {
								JOptionPane.showMessageDialog(null, "Vec postoji lek sa sifrom " + sifra.getText(),
						...
						LekoviController.getInstance().dodajLek(sifra.getText(), naziv.getText(), proizvodjac.getText(),
								naRec, cenaf);
						dispose();
					}
				});
