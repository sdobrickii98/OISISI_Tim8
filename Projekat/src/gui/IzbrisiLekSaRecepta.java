...
public class IzbrisiLekSaRecepta extends JDialog {
	...
	private void jbInit() throws Exception {
		...
		title = new JLabel("Recept - BrisiLek");
		...
		ArrayList<String> spisak = recept.getSpisakLekova();
		...
		b2.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Recept recept = ListaRecepata.getInstance().getRow(row);
				LekoviController.getInstance().UklanjanjeLekaSaRecepta(recept, (String) tf1.getSelectedItem());
				dispose();
			}
